local table = 
{
	...
	[250] = {type = "bank", id = {300000, 0}, msg = "Depositamos 300000 gold coins em sua conta por atingir o level 250!"},
        [300] = {type = "item", id = {36727, 2}, msg = "Receba 2 Wealth duplex por atingir o level 300!"},
        [350] = {type = "mount", id = {124, 0}, msg = "Receba uma montaria por atingir o level 350!"},
        [400] = {type = "addon", id = {1777, 1776}, msg = "Receba o Beekeeper addon completo por atingir o level 400!"},
        [500] = {type = "mount", id = {231, 0}, msg = "Receba a montaria Bumblebee por atingir o level 500!"},
        [600] = {type = "item", id = {36725, 2}, msg = "Receba 2 Stamina extension por atingir o level 600!"},
	[700] = {type = "addon", id = {1569, 1568}, msg = "Receba o Fire-Fighter addon completo por atingir o level 700!"},
