local config = {
    ...
    prizePool = {
        ...
        {itemId = 36725, count = {1, 1},    chance = 1500 }, -- stamina extension
        ...
        {itemId = 34326, count = {1, 1},    chance = 750 },  -- wicked witch
        ...
        {itemId = 21445, count = {1, 1}, chance = 750 },  -- war backpack
        ...
        {itemId = 43895, count = {1, 1},    chance = 500  },  -- sanguine bag
        {itemId = 23684, count = {1, 1},    chance = 200  },  -- crackling egg	
	{itemId = 5919, count = {1, 1},    chance = 400  },  -- Dragon Claw
	{itemId = 20274, count = {1, 1},    chance = 300 }, -- nightmare horn
