local config = {
    ...
    playItem = {
        itemId = 22724, -- item required to pull lever
        count = 1
    },
    rouletteOptions = {
    ...
    prizePool = {
        ...
        {itemId = 39546, count = {1, 1},   chance = 900}, 
        {itemId = 43895, count = {1, 1},   chance = 800}, 
  
    },
    roulettePositions = { -- hard-coded to 7 positions.
        Position(1101, 1062, 4),
        Position(1102, 1062, 4),
        Position(1103, 1062, 4),
        Position(1104, 1062, 4), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(1105, 1062, 4),
        Position(1106, 1062, 4),
        Position(1107, 1062, 4),
        Position(1108, 1062, 4),
        Position(1109, 1062, 4),
    }
}
