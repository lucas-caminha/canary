...
if configManager.getBoolean(configKeys.VIP_SYSTEM_ENABLED) then
	...
	premiumDescription = "<i>Melhore sua experiencia de jogo ganhando vantagens:</i>\n\n"
	if vipBonusExp > 0 then
		premiumDescription = premiumDescription .. "&#8226; +" .. vipBonusExp .. "% exp bonus\n"
	end
	if vipBonusSkill > 0 then
		premiumDescription = premiumDescription .. "&#8226; +" .. vipBonusSkill .. "% de velocidade de treino com weapon exercises\n"
	end
	if vipBonusLoot > 0 then
		premiumDescription = premiumDescription .. "&#8226; +" .. vipBonusLoot .. "% a mais de loot\n"
	end
	if vipStayOnline then
		premiumDescription = premiumDescription .. "&#8226; fique on-line afk sem se desconectar\n"
	end
	premiumDescription = premiumDescription .. "&#8226; receba online coins mais rapidamente\n"
	premiumDescription = premiumDescription .. "&#8226; sistema de lealdade, ganhe skills com este sistema. A cada dia de vip comprado são 16 pontos adquiridos. \n"
	premiumDescription = premiumDescription .. "\n{usablebyallicon} valido para todos os personagens na sua conta \n{activated}"
end
...
GameStore.Categories = {
	...
	-- Extras ~ Usefull Things
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 23721,
				count = 1,
				description = "Armazena todo tipo de loot na bolsa. Limite de 2000 slots.",
	...
	-- Itens
	{
		...
		name = "Exclusive Itens",
		rookgaard = true,
		subclasses = { "Ferramentas", "Custom", "Amber" },
	},
		-- Itens ~ Ferramentas
	{
		icons = { "Category_ExtraServices.png" },
		name = "Ferramentas",
		parent = "Exclusive Itens",
		rookgaard = true,
		state = GameStore.States.STATE_NONE,
		offers = {
			{
			...
			},
			{
				...
				itemtype = 9596,
				count = 1,	
				description = "Pode ser usada como: Juice Squeezer, Rope, Shovel, Pick, Machete, Scythe e Sickle.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				movable = true,
			},
			{
			...
			{
				icons = { "Bone_Fidle.png" },
				name = "Bone Fiddle",
				price = 10,
				itemtype = 28493,
				count = 1,
				description = "a bone fiddle (protection lifedrain +5%)",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				movable = true,
			},
			{
				...
				itemtype = 43863,
				count = 1,
				description = "a conch shell horn (protection ice +5%)",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				movable = true,
			},
			{
			...
			{
				icons = { "Moon_Mirror.png" },
				name = "Moon Mirror",
				price = 10,
				itemtype = 25975,
				count = 1,
				description = "a moon mirror (protection death +5%).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				movable = true,
			},
			{
				...
				itemtype = 25976,
				count = 1,
				description = "a starlight vial (protection manadrain +5%).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				movable = true,
			},
			{
				...
				itemtype = 25977,
				count = 1,
				description = " a sun catcher (protection fire +5%)",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				movable = true,
			},
			{
				...
				itemtype = 16244,
				count = 1,
				description = "Serve para domar montarias e não há possibilidade de falhar.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				movable = true,
			},
			{
				...
				itemtype = 18339,
				count = 1,
				description = "Zaoan chess box (Vol:32).",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				movable = true,
			},
	...
	-- Itens ~ Custom
	{
		...
		offers = {
			{
				icons = { "Copper_Token.png" },
				name = "Tigrinho Token",
				price = 5,
				itemtype = 22722,
				charges = 1,
				description = "Pode ser utilizado no sistema de roleta.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				home = true,
			},
			{
			...
			{
				icons = { "Titanium_Token.png" },
				name = "Super Tigrinho Token",
				price = 30,
				itemtype = 22724,
				charges = 1,
				description = "Pode ser utilizado no sistema de roleta.",
			...
			{
				icons = { "Exalted_Core.gif" },
				name = "Exalted Core",
				price = 5,
				itemtype = 37110,
				charges = 1,
				description = "Usado no sistema de TIER.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "Greater_Marksman_Gem.gif" },
				name = "greater marksman gem",
				price = 5,
				itemtype = 44607,
				charges = 1,
				description = "Usado no sistema de Gemas.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "Greater_Guardian_Gem.gif" },
				name = "greater guardian gem",
				price = 5,
				itemtype = 44604,
				charges = 1,
				description = "Usado no sistema de Gemas.",
			...
			{
				icons = { "Greater_Mystic_Gem.gif" },
				name = "greater mystic gem",
				price = 5,
				itemtype = 44613,
				charges = 1,
				description = "Usado no sistema de Gemas.",
			...
			{
				icons = { "Greater_Sage_Gem.gif" },
				name = "greater sage gem",
				price = 5,
				itemtype = 44610,
				charges = 1,
				description = "Usado no sistema de Gemas.",
			...
			{
				icons = { "Jester_Doll.png" },
				name = "Addon Doll",
				price = 30,
				itemtype = 8778,
				charges = 1,
				description = "Libera todos os outfits basicos completos [Citizen, Hunter, Knight, Noblewoman, Warrior , Barbarian, Druid, Wizard, Assassin, Oriental, Pirate, Beggar, Shaman, Nightmare, Jester, Brotherhood, Elementalist, Deepling, Insectoid ]",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				...
				itemtype = 31633,
				charges = 1,
				description = "Um teleporte onde voce escolhe o templo da cidade que voce deseja ir, tem cooldown de 1h e custo de 10.000 gold coins por uso.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "Seal_of_Quality.png" },
				name = "Stamina Refiler",
				price = 8,
				itemtype = 34079,
				charges = 1,
				description = "Recupera 24h de stamina do seu personagem. 1 carga, sem cooldown.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				...
				itemtype = 35508,
				charges = 1,
				description = "Ao usar você recebe um novo familiar referente a sua vocação. ED[Mossmasher], EK[Snowbash], RP[Sandscourge], MS[Bladespark].",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
		...
		offers = {
			{
				...
				itemtype = 47371,
				charges = 1,
				description = "an amber bow (Range: 6, Atk +7, Hit% +6, distance fighting +3, protection energy +5%). It can only be wielded properly by paladins of level 330 or higher. Augments: (Divine Grenade -> +8% critical extra damage). Imbuements: 3 slots. Classification: 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				home = true,
			},
			{
				...
				itemtype = 47377,
				charges = 1,
				description = "an amber crossbow (Range: 6, Atk +8, Hit% +7, distance fighting +3, protection energy +5%). It can only be wielded properly by paladins of level 330 or higher. Augments: (Divine Missile -> +5% critical extra damage). Imbuements: 3 slots. Classification: 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 47370,
				charges = 1,
				description = "a amber bludgeon (50 death, Def:34, club fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> +14% critical extra damage, Annihilation -> -8s cooldown). Imbuements: (Empty Slot, Empty Slot). Classific 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				icons = { "Amber_Cludgeon.png" },
				name = "Amber cudgel",
				price = 20,
				itemtype = 47376,
				charges = 1,
				description = "a amber cudgel (46 fire, Def:32 +3, club fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> +14% critical extra damage, Annihilation -> -8s cooldown). Imbuements: (Empty Slot, Empty Slot). Classification 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 47373,
				charges = 1,
				description = "a amber rod (magic level +3, ice magic level +2, protection fire +6%). It can only be wielded properly by druids of level 600 or higher. Augments: (Strong Ice Wave -> +6% critical extra damage). Imbuements: (Empty Slot, Empty Slot). Classification 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				home = true,
			},
			{
				...
				itemtype = 47372,
				charges = 1,
				description = "a amber wand (magic level +3, energy magic level +2, protection ice +6%). It can only be wielded properly by sorcerers of level 330 or higher. Augments: (Rage of The Skies -> +10% critical extra damage). Imbuements: (Empty Slot, Empty Slot). Classification 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 47374,
				charges = 1,
				description = "a amber sabre (46 earth, Def:32 +3, sword fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> +14% critical extra damage, Annihilation -> -8s cooldown). Imbuements: (Empty Slot, Empty Slot). Classification 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 47375,
				charges = 1,
				description = "a amber axe (46 ice, Def:32 +3, axe fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> +14% critical extra damage, Annihilation -> -8s cooldown). Imbuements: (Empty Slot, Empty Slot). Classification 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 47369,
				charges = 1,
				description = "a amber greataxe (50 earth, Def:34, axe fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> +14% critical extra damage, Annihilation -> -8s cooldown). Imbuements: (Empty Slot, Empty Slot). Classification 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
			{
				...
				itemtype = 47368,
				charges = 1,
				description = "a amber slayer (50 death, Def:34, sword fighting +4). It can only be wielded properly by knights of level 330 or higher. Augments: (Annihilation -> +14% critical extra damage, Annihilation -> -8s cooldown). Imbuements: (Empty Slot, Empty Slot). Classification 4.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
			},
		},
	...
	-- Online Coins
	{
		...
		name = "Online Coins",
		rookgaard = true,
		subclasses = { "Itens", "House", "Consumiveis", "Varinhas", "Outfits e Mounts" },
	},
	-- Online ~ Itens
	{
		icons = { "Category_Tickets.png" },
		...
		offers = {
			{
				icons = { "Gold_Token.gif" },
				name = "Gold Token",
				price = 15,
				itemtype = 22721,
				count = 50,
				description = "Voce pode ir ate a Adventurers' Guild, e falar com este NPC para trocar 50 Gold Tokens por armas especiais.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Silver_Token.gif" },
				name = "Silver Token",
				price = 15,
				itemtype = 22516,
				count = 100,
				description = "Voce pode ir ate a Adventurers' Guild, e falar com este NPC para trocar 100 Silver Tokens por armaduras especiais ou entao addons para o outfit Rift Warrior.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Major_Crystalline_Token.gif" },
				name = "Major Crystalline Token",
				price = 10,
				itemtype = 16129,
				count = 10,
				description = "Esses tokens sao uma especie de dinheiro, e podem ser usados para comprar itens com a NPC Gnomally.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			...
			},
			{
				...
				itemtype = 20090,
				charges = 1,
				description = "(Def:20, magic level +4, protection energy +5%, earth +5%, fire +5%, ice +5%). Level 250.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 20084,
				charges = 1,
				description = "(Range: 7, Atk +6, Hit% +5, distance fighting +3). Level 250.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 20087,
				charges = 1,
				description = "(Range: 5, Atk +9, Hit% +4, distance fighting +3). Level 250.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 20078,
				charges = 1,
				description = "(Atk:52, Def:30 +3, club fighting +1). Level 250.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 20081,
				charges = 1,
				description = "(Atk:55, Def:34, club fighting +3). Level 250.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 20072,
				charges = 1,
				description = "(Atk:53, Def:34, axe fighting +1). Level 250.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 20075,
				charges = 1,
				description = "(Atk:54, Def:34, axe fighting +3). Level 250.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 20066,
				charges = 1,
				description = "(Atk:52, Def:31 +3, sword fighting +1). Level 250.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 20069,
				charges = 1,
				description = "(Atk:54, Def:35, sword fighting +3). Level 250.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Dwarven_Legs.png" },
				name = "Dwarven Legs",
				price = 15,
				itemtype = 3398,
				charges = 1,
				description = "(Arm:7, protection physical +3%).",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 35524,
				charges = 1,
				description = "(Vol:8. It can only be wielded properly by paladins of level 150 or higher.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Zaoan_Helmet.png" },
				name = "Zaoan Helmet",
				price = 15,
				itemtype = 10385,
				charges = 1,
				description = "(Arm:9, protection physical +5%). It can only be wielded properly by knights and paladins.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Foxtail_Amulet.png" },
				name = "Foxtail Amulet",
				price = 15,
				itemtype = 27565,
				charges = 1,
				description = "foxtail amulet (Arm:2, protection physical +5%).",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Prismatic_Ring.png" },
				name = "Prismatic Ring",
				price = 5,
				itemtype = 16114,
				charges = 1,
				description = "You see a prismatic ring (protection physical +10%, energy +8%). Duração de 1h.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				...
				itemtype = 46628,
				charges = 1,
				description = "Serve para quebras gemas e usar no sistema de Gemas.",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
	...
	-- Online ~ Consumiveis
	{
		...
		offers = {
			...
			{
				icons = { "Kooldown-Aid.gif" },
				name = "Kooldown-Aid",
				price = 15,
				itemtype = 36723,
				count = 1,
				description = "Reduz para zero o tempo de recarga de todas as magias em recarga, uma unica vez.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Strike_Enhancement.gif" },
				name = "Strike Enhancement",
				price = 15,
				itemtype = 36724,
				count = 1,
				description = "Aumenta a chance de causar dano critico em 5% por uma hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Stamina_Extension.gif" },
				name = "Stamina Extension",
				price = 15,
				itemtype = 36725,
				count = 1,
				description = "Enche uma hora de stamina, mas nao ultrapassa o limite maximo.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Charm_Upgrade.gif" },
				name = "Charm Upgrade",
				price = 15,
				itemtype = 36726,
				count = 1,
				description = "Aumenta as chances de acionar um charm ofensivo em 5% (exceto Cripple) por uma hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Wealth_Duplex.gif" },
				name = "Wealth Duplex",
				price = 15,
				itemtype = 36727,
				count = 1,
				description = "Dobra o loot de todos os monstros normais mortos por uma hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Bestiary_Betterment.gif" },
				name = "Bestiary Betterment",
				price = 15,
				itemtype = 36728,
				count = 1,
				description = "Faz com que as mortes para o Bestiario, contem duas vezes por uma hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			-- Resilience items
			{
				icons = { "Fire_Resilience.gif" },
				name = "Fire Resilience",
				price = 15,
				itemtype = 36729,
				count = 1,
				description = "Aumenta a protecao em 8% por uma hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Ice_Resilience.gif" },
				name = "Ice Resilience",
				price = 15,
				itemtype = 36730,
				count = 1,
			...
			-- Amplification items
			{
				icons = { "Fire_Amplification.gif" },
				name = "Fire Amplification",
				price = 15,
				itemtype = 36736,
				count = 1,
				description = "Aumenta o dano fazendo com que seus ataques e magias tratem as sensibilidades do alvo como se fossem 8% maiores por uma hora.",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				movable = true,
				coinType = GameStore.CoinType.Coin,
			},
			{
				icons = { "Ice_Amplification.gif" },
			...
			{
				icons = { "Energy_Amplification.gif" },
			...
			{ 
				icons = { "Physical_Amplification.gif" },
