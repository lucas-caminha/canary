local teleports = {
	...
	{ teleportPosition = { x = 32803, y = 31798, z = 9 }, destination = Position(32627, 31864, 11), storageValue = 1, needCrystal = false },
	...
	{ teleportPosition = { x = 32805, y = 31743, z = 9 }, destination = Position(32329, 32172, 9), storageValue = 1, needCrystal = false },
	{ teleportPosition = { x = 32786, y = 31754, z = 9 }, destination = Position(32195, 31182, 8), storageValue = 1, needCrystal = false },
	{ teleportPosition = { x = 32772, y = 31776, z = 9 }, destination = Position(32402, 32816, 6), storageValue = 1, needCrystal = false },
	{ teleportPosition = { x = 32831, y = 31797, z = 9 }, destination = Position(33153, 31833, 10), storageValue = 1, needCrystal = false },
	{ teleportPosition = { x = 32827, y = 31757, z = 9 }, destination = Position(33186, 32385, 8), storageValue = 1, needCrystal = false },
