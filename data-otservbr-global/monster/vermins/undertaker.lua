...
monster.attacks = {
	...
	{ name = "combat", interval = 4500, chance = 47, type = COMBAT_DEATHDAMAGE, minDamage = -800, maxDamage = -1550, radius = 4, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = true },
	...
	{ name = "undertaker square explosion", interval = 3000, chance = 25, minDamage = -775, maxDamage = -1200, range = 4, target = true },
